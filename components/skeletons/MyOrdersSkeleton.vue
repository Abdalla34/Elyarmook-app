    ...
    <div class="col-lg-7 col-md-10 col-sm-12">
      ...
      >
        <div class="details-title d-flex align-items-center gap-3">
          <div
            class="placeholde-wave rounded bg-secondary"
            style="width: 60px; height: 60px"
          ></div>

          <div class="name price w-100">
            <h4 class="placeholde-wave col-6 mb-2"></h4>
            <p class="placeholde-wave col-4 mb-0"></p>
          </div>
        </div>

        <div class="time-branch text-end">
          <p class="placeholde-wave col-6 mb-2"></p>
          <p class="placeholde-wave col-4"></p>
        </div>
      </div>
    </div>
  </div>
