<template>
  <div class="poup-permium">
    <div class="box-parent mt-3 border-radius-36px">
      <div class="parent d-flex align-items-center justify-content-between">
        <div class="name-status mt-5 d-flex align-items-center gap-3">
          <div class="img-order">
            <img :src="carImg" alt="" />
          </div>
          <div class="name-order">
            <h4 class="text-capitalize">{{ nameCar }}</h4>
            <p class="pt-2 price">
              {{ priceOrder }} <span class="span">SAR</span>
            </p>
          </div>
        </div>
        <div class="status">
      ...
      <div class="model-order margin-top d-flex justify-content-between gap-3">
        <div class="car-model box-car">
          <div
            class="car d-flex align-items-center justify-content-center gap-4"
          >
            <div class="car-box">
              <svg
                width="24"
            ...
            <div class="name-car">
              <span class="span-car text-capitalize">car model</span>
              <h4 class="h4">{{ carModel }}</h4>
            </div>
          </div>
        </div>

        <div class="order-num box-car">
          <div
            class="number d-flex align-items-center justify-content-center gap-4"
          >
            <div class="car-box">
              <svg
                width="25"
            ...
            <div class="name-car">
              <span class="span-car text-capitalize">order number</span>
              <h4 class="h4">#{{ ordernum }}</h4>
            </div>
          </div>
        </div>
      </div>

      <div class="time-order d-flex justify-content-between gap-3">
        <div class="time text-center box-order border-radius-36px">
          <div class="box-icon">
            <TimeIcon />
          </div>
          <div class="days-time">
            <h4>
              {{ day }} {{ daynum }} {{ month }}, {{ year }} {{ hour }}
              {{ minutes }}
            </h4>
        ...
        <div class="order text-center box-order border-radius-36px">
          <div class="box-icon">
            <LocationIcon />
          </div>
          <div class="days-time">
            <h4>{{ location }}, {{ streatname }}</h4>
            <p>Reschedule Order</p>
          </div>
        </div>
      </div>
      ...
      <div class="steps">
        <ul class="ul-step d-flex gap-4 justify-content-center">
          <li>
            <div class="bg-icons test">
              <svg
                width="24"
                height="25"
                viewBox="0 0 24 25"
      ...
      <div
        class="order-amount bg-order-amonut d-flex align-items-center justify-content-between mt-3"
      >
        <p class="p-title text-capitalize">order amount</p>
        <p class="p-num">300315382500003</p>
      </div>

      <div
        class="order-amount bg-order-amonut d-flex align-items-center justify-content-between mt-3"
      >
        <p class="p-title text-uppercase">vat</p>
        <p class="p-num">300315382500003</p>
      </div>

      <div
        class="total-amount d-flex align-items-center justify-content-between mt-3"
      >
        <p class="p-total text-capitalize">total amount</p>
        <p class="price">60 <span class="price-currency">sar</span></p>
      </div>

      <div class="button-accept">
        <ButtonCard textButton="acept and pay" :isActive="false" />
      </div>
      <div class="cancel text-capitalize p-color-fs text-center">
        cancel order
      </div>
    </div>
  </div>
...
<style scoped>
@import "./assets/css/poupPremium.css";
</style>
